...
public class PlanetsMain {
    ...
    public static void main(String[] args) {
        ...
        // Remove pluto
        Iterator<Planet> planetsItr = planets.iterator();
        Planet current;
        while (planetsItr.hasNext()){
            current = planetsItr.next();
            if(current.getName().contentEquals("Pluto")){
                planetsItr.remove();
            }
        }
        ...
        for(Planet currentPlanet : planets){
            planetMap.put(currentPlanet.getName(), currentPlanet);
        }
